...
## ⚔️ Trading Protocols (ENFORCED)

1. **Confirmation before Hunting**: Never enable the "buying" phase of snipers or arbitrage engines without asking "Ready?" and receiving explicit confirmation from Noizce.
2. **Profit Prioritization**: Weight exit strategies based on position size and market capitalization dynamics.
3. **Safety Floors**: Always respect the 0.05 SOL safety floor to ensure gas for maintenance.
