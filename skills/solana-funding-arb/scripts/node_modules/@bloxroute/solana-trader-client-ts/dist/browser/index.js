...
var testnet = "serum-nlb-5a2c3912804344a3.elb.us-east-1.amazonaws.com";
...
var TESTNET_API_HTTP = httpEndpoint(testnet, false);
var TESTNET_API_WS = wsEndpoint(testnet, false);
var TESTNET_API_GRPC_HOST = testnet;
var TESTNET_API_GRPC_PORT = 80;
...
var WsProvider = class extends BaseProvider {
  ...
  async getBundleResultV2(request) {
    return await this.wsConnection.call("GetOpenOrdersV2", request);
  }
