...
import { Connection, Signer, PublicKey, Transaction, VersionedTransaction, TransactionSignature, ConfirmOptions, Commitment, SendOptions } from "@solana/web3.js";
...
export declare function sendAndConfirmRawTransaction(connection: Connection, rawTransaction: Buffer | Uint8Array, options?: ConfirmOptions): Promise<TransactionSignature>;
/**
