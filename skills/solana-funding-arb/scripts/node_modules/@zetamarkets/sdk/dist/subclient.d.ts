...
export declare class SubClient {
     ...
     */
    static load(asset: Asset, parent: Client, connection: Connection, user: PublicKey, fetchedAccs: any[], callback?: (asset: Asset, type: EventType, data: any) => void, throttle?: boolean): SubClient;
