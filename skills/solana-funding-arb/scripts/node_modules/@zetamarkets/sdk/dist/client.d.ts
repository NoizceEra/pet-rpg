...
export declare class Client {
    ...
    private constructor();
    private _subClients;
    static load(connection: Connection, wallet: types.Wallet, opts?: ConfirmOptions, callback?: (asset: Asset, type: EventType, data: any) => void, throttle?: boolean, delegator?: PublicKey, useVersionedTxs?: boolean): Promise<Client>;
    ...
    getMarginAccountState(asset: Asset, pnlExecutionPrice?: number, pnlAddTakerFees?: boolean): types.MarginAccountState;
    ...
    cancelAllPerpMarketOrders(): Promise<TransactionSignature>;
    ...
    getSpreadAccount(asset: Asset): SpreadAccount | null;
    getSpreadAccountAddress(asset: Asset): PublicKey;
    getMarginAccount(asset: Asset): MarginAccount | null;
