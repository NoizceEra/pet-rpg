...
declare module "zeta-solana-web3" {
...
export class Connection {
     ...
     */
    onAccountChange(publicKey: PublicKey, callback: AccountChangeCallback, commitment?: Commitment, encoding?: 'base64' | 'base64+zstd' | 'jsonParsed'): ClientSubscriptionId;
    /**
     ...
     * @return subscription id
     */
    onProgramAccountChange(programId: PublicKey, callback: ProgramAccountChangeCallback, commitment?: Commitment, filters?: GetProgramAccountsFilter[], encoding?: 'base64' | 'base64+zstd' | 'jsonParsed'): ClientSubscriptionId;
    /**
     * Deregister an account notification callback
     *
     * @param id client subscription id to deregister
    ...
    _buildArgs(args: Array<any>, override?: Commitment, encoding?: 'base64' | 'base64+zstd' | 'jsonParsed', extra?: any): Array<any>;
    /**
